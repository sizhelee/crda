...
def main():
    ...
    parser.add_argument('--pcd_data_dir', default='/network_space/storage43/lisizhe/dataset/referit3d/scan_data/pcd_with_global_alignment_pred/')
    parser.add_argument('--bbox_out_dir', default='/network_space/storage43/lisizhe/dataset/referit3d/scan_data/instance_id_to_loc_pred/')
